...
There is no data available in the Comtrade database for KNA (1995-2000)\
ATG (1995-2000), BOL (2015-2020), BRA (2015-2020)

-   ARG, BOL, BRA and CHL are from the `sa_exports_fst` tibble. Curious, huh?

-   Nor, KNA and ATG are countries with extremely low levels of output.
